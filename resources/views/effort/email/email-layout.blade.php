...
<span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">{{ $intro }}</span>
            ...
            <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; -premailer-width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; margin: 0; padding: 0;">
                <tr>
                    <td class="email-masthead" style="word-break: break-word; font-family: 'Nunito Sans', Helvetica, Arial, sans-serif; font-size: 16px; text-align: center; padding: 25px 0;" align="center">
                        <a href="{{ config('custom.scl_url_portal') }}" class="f-fallback email-masthead_name" style="color: #A8AAAF; font-size: 16px; font-weight: bold; text-decoration: none; text-shadow: 0 1px 0 white;">
                            UW {{ config('custom.scl_long') }}
                        </a>
                    </td>
                </tr>
                <!-- Email Body -->
                            ...
                            <tr>
                                <td class="content-cell" style="word-break: break-word; font-family: 'Nunito Sans', Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                                    <div class="f-fallback">
                                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">{{ $intro }}</p>
                                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; text-align: center; font-weight: normal;" align="center">
                                            <span style="font-weight: bold;">{{ $projectTitle }}</span><br>
                                            Submitted {{ $submitted }}
                                        </h1>
                                        <!-- Action -->
                                 ...
                                 https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" role="presentation">
                                                        <tr>
                                                            <td align="center" style="word-break: break-word; font-family: 'Nunito Sans', Helvetica, Arial, sans-serif; font-size: 16px;">
                                                                <a href="{{ $url }}" class="f-fallback button" target="_blank" style="color: #FFF; border-color: #3869d4; border-style: solid; border-width: 10px 18px; background-color: #3869D4; display: inline-block; text-decoration: none; border-radius: 3px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.16); -webkit-text-size-adjust: none; box-sizing: border-box;">View {{ $reportType }}</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                        ...
                                        <p style="font-size: 16px; line-height: 1.625; color: #51545E; margin: .4em 0 1.1875em;">View this {{ $reportType }} at <a href="{{ $url }}">{{ $url }}</a></p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td class="content-cell" align="center" style="word-break: break-word; font-family: 'Nunito Sans', Helvetica, Arial, sans-serif; font-size: 16px; padding: 45px;">
                                    <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">
                                        ...
                                        of the Environment's {{ $appName }}. If you have trouble with this notification or
                                        have received this message in error, please contact the college Help Desk at
                                        <strong>itreq@uw.edu</strong>.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
