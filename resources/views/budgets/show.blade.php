        ...
        <div class="col-md-9">
            <div class="mb-5">
                ...
                <div class="flex-columns mb-2">
                    ...
                    @if(hasRole('uwft'))
                    <section class="mb-5">
                        <h2 class="mb-3">UWFT Worktags</h2>

                        @include('budgets._worktags')
                    </section>
                    @endif
            ...
            @include('effort.allocations-by-budget._allocations-by-budget')
            @include('budgets/_uw-budget', ['uwBudget' => $uwBudget ?? $budget->uw])
